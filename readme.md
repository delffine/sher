...
## Демо дашбордов в DataLens

В демо версии используются реальные данные продаж через Wildberries и Ozon за сентябрь 2025 года, но с измененными артикулами.

[Демо DataLens](https://datalens.yandex/5lkk5iqa9alsq)
